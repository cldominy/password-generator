...
var alertLength = "Your password will have the following amount of characters: " + userLength;
...
// Password Parameters Selection
  ...
  // Lowercase Selection
  var userLower = confirm("Do you want lowercase letters in your password? Select OK if you do");
  if (userLower === true){
  ...
  // Uppercase Selection
  var userUpper = confirm("Do you want uppercase letters in your password? Select OK if you do");
  if (userUpper === true){
  ...
  // Number Selection
  var userNumbers = confirm("Do you want numbers in your password? Select OK if you do");
  if (userNumbers === true){
  ...
  var userSpecial = confirm("Do you want special characters in your password? Select OK if you do");
  if (userSpecial === true){
...
// Parameters not selected
  while (userLower === false && userUpper === false && userNumbers === false && userSpecial === false){
...
for (var p = 0; p < userLength; p++){
  passwordFinal = passwordFinal + userChoicePasword[Math.floor(Math.random()*userChoicePasword.length)];
}
